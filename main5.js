...
// contains the 3 elements: "Pepperoni", 12.99, false
   ...
   const myPizzaOrder2 = ["cheese", 12.99, false]
...
// Hint: find the method that will allow you to set the decimals.
    ...
    function addTax(myPizzaOrder){
        let a = myPizzaOrder[1]*0.0925;
        console.log(a)
         return myPizzaOrder.splice(2, 0, a);

    }

    const myPizzaOrder1 = [1,2,3,4];
console.log(myPizzaOrder1)
addTax(myPizzaOrder1)
console.log(myPizzaOrder1)
...
// element in the array to true and return the array.
    ...
    function completeOrder (array){
            array.splice(3, 0, true);
            return array
    } 

    console.log(myPizzaOrder1)
    completeOrder(myPizzaOrder1)
    console.log(myPizzaOrder1)
...
// return the last element.
    ...
    function getLastElemnt(lastArray){
